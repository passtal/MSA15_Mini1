...
<ul class="gnb flex">
	<li class="m_shop ${dp1 eq 'shop' ? 'on' : ''}">
		...
		<ul class="dp2 flex">
			...
			<li class="sm_map ${dp1 eq 'shop' and dp2 eq 'map' ? 'on' : ''}"><a href="${ root }/page/shop/shop_map.jsp" class="flex ac"><span class="tt">${ nav.shop_map }</span></a></li>
			...
			<li class="sm_board ${dp1 eq 'board' and dp2 eq 'list' ? 'on' : ''}"><a href="${ root }/page/notice/list.jsp" class="flex ac"><span class="tt">${ nav.board_list }</span></a></li>
		</ul>
	</li>	
