...
| 이름 | 역할 | 담당 업무 |
|:---:|:---:|:---|
| **최영우** | 팀장 | • 프로젝트 총괄 <br> • 주요 문서 작성 <br> • 게시판 기능 구현 <br> • 데이터베이스 연동 및 처리 <br> • 기능 테스트 및 오류 수정 |
| **정성준** | 팀원 | • 기능 구현 및 데이터 처리 <br> • ERD 설계 <br> • 회원가입 및 로그인 기능 구현 <br> • 데이터베이스 연동 및 처리 <br> • 기능 테스트 및 오류 수정 |
| **이효미** | 팀원 | • 화면 설계 및 UI 구성 <br> • 화면 설계도 작성 <br> • 전반적인 UI 구성 <br> • 기능 테스트 |
